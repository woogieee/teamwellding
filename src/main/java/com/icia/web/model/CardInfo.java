...
public class CardInfo implements Serializable
{
	...
	{
		return "{purchase_corp:"+purchase_corp+", purchase_corp_code:"+purchase_corp_code+
				...
				", kakaopay_issuer_corp_code:"+kakaopay_issuer_corp_code+", bin:"+bin+
				", card_type:"+card_type+", install_month:"+install_month+", approved_id:"+
				approved_id+", card_mid:"+card_mid+", interest_free_install:"+interest_free_install+
